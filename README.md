...
│
├── pyproject.toml     <- Project configuration file with package metadata for optiml_automl
...
│
└── optiml_automl                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes optiml_automl a Python module
    │
